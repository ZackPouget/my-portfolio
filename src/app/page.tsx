...
export default function Home() {
  return (
    <main className="min-h-screen bg-gray-50 dark:bg-gray-800 text-gray-800 dark:text-gray-100">
      {/* Hero Section */}
      <section className="flex flex-col items-center justify-center text-center py-16 px-6">
        ...
        <h2 className="text-2xl text-gray-600 dark:text-gray-300 mb-6">Software Developer</h2>
        <p className="max-w-2xl text-lg text-gray-500 dark:text-gray-300">
      ...
      {/* Skills Section */}
      <section className="py-20 bg-white dark:bg-gray-700 text-center">
      ...
      <section className="py-20 bg-grey-50 text-center">
        ...
        <div className="flex justify-center gap-6">
          <a
            ...
            className="text-blue-600 dark:text-sky-600 hover:underline"
          >
            {/* #648efc */}
